/*
This function returns the greatest product between the "n" adjacent digits of a
1000-digit number.
*/
...
function largestProductinaSeries(n) {
    ...
    for (let i = n; i <= thousandDigits.length; i++) {
        auxArray = thousandDigits.slice(i - n, i);
        auxVal = thousandDigits
            .slice(i - n, i)
            .reduce(
                (previousValue, currentValue) => previousValue * currentValue
            );
        auxVal > greatestProduct ? (greatestProduct = auxVal) : {};
    }
